...
static int pg_vexdb_vector_buffers = 262144;  /* 256K buffers */
...
extern "C" relopt_kind pg_vexdb_relopt_kind = relopt_kind{};
...
pg_vexdb_init_guc(void)
{
    ...
    DefineCustomIntVariable("pg_vexdb.vector_buffers",
                            "Number of vector buffers to allocate.",
                            "Total number of 8KB buffers for the vector buffer manager.",
                            &pg_vexdb_vector_buffers,
                            262144,  /* 256K buffers = 2GB */
                            1024, INT_MAX,
                            PGC_POSTMASTER,
                            GUC_UNIT_BLOCKS,
                            NULL, NULL, NULL);
