...
/* Vector fork number - PostgreSQL doesn't have this, use main */
#define VECTOR_FORKNUM MAIN_FORKNUM
...
extern "C" relopt_kind pg_vexdb_relopt_kind;
#define RELOPT_KIND_GRAPH_INDEX pg_vexdb_relopt_kind

/* Session attributes - only pg_vexdb specific settings */
typedef struct {
    int ef_search;
...
extern "C" PgVexdbSessionAttrs pg_vexdb_session;
#define u_sess (&pg_vexdb_session)
...
extern "C" int pg_vexdb_lock_tranche_id;
#define LWTRANCHE_EXTEND pg_vexdb_lock_tranche_id
