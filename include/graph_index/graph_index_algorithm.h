...
retry:
        ...
        std::vector<Vector<Cand>> nbr_record(search_level); /* record nbr in search */
#else
    ...
    void repair_graph_parallel(RepairGraphSharedState &ss)
    {
        ...
        while (true) {
            ...
            repair_base_range(start, end - start, *ss.deleted);
        }
        ...
        while (true) {
            ...
            repair_upper_range(start, end - start, *ss.deleted);
        }
        CONSTEXPR_IF (use_dist_cache) {
    ...
    void repair_graph_remaining(RepairGraphSharedState &ss)
    {
        ...
        if (prev_basepoint_num > ss.basepoint_num) {
            repair_base_range(ss.basepoint_num, prev_basepoint_num - ss.basepoint_num, *ss.deleted);
        }
        if (prev_upperpoint_num > ss.upperpoint_num) {
            repair_upper_range(ss.upperpoint_num, prev_upperpoint_num - ss.upperpoint_num, *ss.deleted);
        }
        ...
        if (final_basepoint_num > prev_basepoint_num) {
            repair_base_range(prev_basepoint_num, final_basepoint_num - prev_basepoint_num, *ss.deleted);
        }
        if (final_upperpoint_num > prev_upperpoint_num) {
            repair_upper_range(prev_upperpoint_num, final_upperpoint_num - prev_upperpoint_num, *ss.deleted);
        }
